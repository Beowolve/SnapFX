...
- ✅ **WS-1 sidebar transient-state slice**: Sidebar selection/overlay/collapse/mode transient logic was extracted from `SnapFX` into `org.snapfx.sidebar.DockSideBarController`
