package org.snapfx.demo.editor;
 ...
 */
public final class EditorCloseDecisionPolicy {
    ...
    public EditorCloseDecisionPolicy(
    ...
    public DockCloseDecision resolve(DockCloseRequest request) {
